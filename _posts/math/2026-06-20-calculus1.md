...
author: "Jayadeep"
categories: math
tags: [documentation,calculus basics, Partial fractions, partial differentiation, integration,June26]
image:
---
...
## Partial fractions:
- When the function(fraction) is too complicated to differentiate, we can decompose the fraction into smaller functions and work with them
- for example: 
